...
/*
 * Динамическая идентификация типа данных (RTTI - Run-time type information) — это механизм в C++, который раскрывает информацию о
 * типе данных объекта во время выполнения и доступен только для классов, имеющих хотя бы одну виртуальную функцию. Он позволяет
