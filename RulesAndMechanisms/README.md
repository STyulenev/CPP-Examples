...
* Literals  
Пользовательский литерал — это механизм в языке C++, который позволяет создавать собственные расширения для синтаксиса литералов, чтобы сделать код более читаемым и удобным для конкретных задач
...
Деструктурирующее связывание - это механизм декомпозиции объекта на отдельные переменные.
