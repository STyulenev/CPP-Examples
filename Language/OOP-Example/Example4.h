 ...
 *
 * Решение ромбовидного наследования:
 * - виртуальное наследование
 * - явно указать путь к методу
 * - использовать приведение типов
 * - переопределить проблемный метод в самом нижнем классе-получателе, чтобы конкретизировать поведение
 */
namespace Example4 {
